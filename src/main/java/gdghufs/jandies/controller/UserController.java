...
public class UserController {
    ...
    @Operation(summary = "링크트리 저장 - ❌토큰과 LinkTreeDto 필요", tags = {"LinkTree"})
    ...
    @Operation(summary = "링크트리 삭제 - ❌토큰과 링크트리 ID 필요", tags = {"LinkTree"})
    ...
    @Operation(summary = "링크트리 수정 - ❌토큰과 LinkTreeDto 필요", tags = {"LinkTree"})
